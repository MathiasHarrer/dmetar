...
#' data is provided as the standardized mean difference (\emph{SMD}) between the intervention
...
#' \describe{
#' \item{study}{\code{character}. The name of the included study.}
#' \item{treatment}{\code{character}. The name of the treatment under study. Includes psychotherapies for
...
#' \item{diff}{\code{numeric}. The standardized mean difference of the comparison. The row in each study in which
#' this variable is \code{NA} represents the comparison condition for the effect size displayed above.}
#' \item{std.err}{\code{numeric}. The standard error of the comparison. The row in each study in which
