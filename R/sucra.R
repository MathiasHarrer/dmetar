...
#'
#' @param x An object of class \code{mtc.result} generated by the \code{\link[gemtc]{mtc.run}} function or
#' a matrix/data.frame in which the rows correspond to the treatment, and columns to the
...
#'
#' Other than an object of class \code{mtc.result} for argument \code{x}, the function can also be provided
...
sucra = function(x, lower.is.better = FALSE, plot = TRUE) {
    ...
    if (class(x) == "mtc.result"){

      rank.probability = rank.probability(x)
