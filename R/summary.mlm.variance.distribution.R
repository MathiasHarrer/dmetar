...
#'
#' @param object An object of class \code{mlm.variance.distribution}.
...
#'
#' @export
#' @method summary mlm.variance.distribution

summary.mlm.variance.distribution = function(object, ...){
